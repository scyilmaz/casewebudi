		...
		<SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
			<KeyboardAwareScrollView>
				<View style={styles.inputContainer}>
					...
					<TouchableOpacity disabled={submitLoading} style={[styles.buttonStyle, { backgroundColor: submitLoading ? "#233929" : "#41644A" }]} onPress={handleLogin}>
						<Text style={styles.buttonText}>Giriş</Text>
						{submitLoading && <ActivityIndicator style={{ marginLeft: 20 }} size={"small"} color={"white"} />}
					</TouchableOpacity>
