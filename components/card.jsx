...
const Card = ({ product }) => {
	...
	return (
		<View style={styles.container}>
			...
			<TouchableOpacity style={[styles.inBuy, addToCardLoading && { backgroundColor: "#324837", height: 44 }]} onPress={handleAddToCartClick}>
				{addToCardLoading && <ActivityIndicator size='small' color='#fff' />}
				<Text style={[styles.buyText, addToCardLoading && { color: "#fff", marginLeft: 6, fontSize: addToCardLoading ? 12 : 14 }]}>{addToCardLoading ? "SEPETE EKLENİYOR" : "SEPETE EKLE"}</Text>
			</TouchableOpacity>
		</View>
	);
};
